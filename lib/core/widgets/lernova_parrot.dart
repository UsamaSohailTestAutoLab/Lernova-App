...
class LernovaParrot extends StatefulWidget {
  ...
  /// Draws the "Lernova" wordmark underneath, matching the brand style
  ...
  const LernovaParrot({
    super.key,
    this.size = 96,
    this.mood = LernovaParrotMood.happy,
    this.animate = false,
    this.showWordmark = false,
  });

  @override
  State<LernovaParrot> createState() => _LernovaParrotState();
}

class _LernovaParrotState extends State<LernovaParrot>
...
class _ParrotPainter extends CustomPainter {
  ...
  void _face(Canvas canvas, double w, double h) {
    ...
    switch (mood) {
      case LernovaParrotMood.celebrate:
        _happyArc(canvas, leftEye, w);
        _happyArc(canvas, rightEye, w);
      case LernovaParrotMood.curious:
